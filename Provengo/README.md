...
## How we tested:
1. We started by creating the [story files](prestaShop/spec/js/WishListStory.js).
2. We then ran the following command to generate the test model:
``` 
provengo analyze -f PDF helloprovengo   
```
3. We repeated steps 1-2 until we were satisfied with the generated model.
4. We added [Event definitions](prestaShop/spec/js/WishList.EventDef.js) to define how the stories actuate the website using Selenium.
...
### Story files
The test stories are in [Tests.story.js](prestaShop/spec/js/WishListStory.js). See the file for a detailed description of the stories.
...
The specification for the events are given in [EventDef.js](prestaShop/spec/js/WishList.EventDef.js). See the file for a detailed description of the events.
